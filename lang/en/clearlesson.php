...
$string['clearwatchedonreset'] = 'Recompletion reset and watched status';
$string['clearwatchedonresetinfo'] = 'Should the video watched status be cleared when the activity is reset?';
$string['clearwatchedonrenew'] = 'Pathways renewal and watched status';
$string['clearwatchedonrenewinfo'] = 'Should the video watched status be cleared when the activity is renewed?';
$string['resetrenewclearwatched'] = 'Recompletion reset or Pathways renewal and watched status';
$string['resetrenewclearwatchedinfo'] = 'Should the video watched status be cleared when the activity is renewed or reset?';
